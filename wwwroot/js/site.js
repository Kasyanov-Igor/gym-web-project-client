...
function transitionClient(ajaxUrl, requestToken, redirectUrl, responseId) {
	$.ajax({
		type: "POST",
		url: ajaxUrl,
		headers: {
...
document.addEventListener('DOMContentLoaded', () => {
	...
	let btnUserLogin = document.getElementById('UserLogin');

	let btnCouchLogin = document.getElementById('loginCouch');
	...
	if (btnCouchLogin != null) {
		btnCouchLogin.addEventListener("click", function () {
